package com.burcuerdogan.instagramclonejava.adapter;
...
import com.burcuerdogan.instagramclonejava.databinding.RecyclerRowBinding;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        holder.recyclerRowBinding.recyclerViewUsernameText.setText(postArrayList.get(position).username);
